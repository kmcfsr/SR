...
#        temp_counter += 1
#        if temp_counter < 200:
        testpath = "C:/Users/main/Documents/SR/ML/UdacityL1/ud120-projects-master/tools/"+path[:-1]
        path = os.path.join('..', path[:-1])
        email = open(testpath, "r")
...
#
#You can access the mapping between words and feature numbers using get_feature_names(), which returns a list of all 
#the words in the vocabulary. How many different words are there?
